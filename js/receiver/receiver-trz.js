...
function preaquecerNarrador() {
    ...
    // ✅ PEGA O IDIOMA DA SUA BANDEIRA LOCAL (já existente no seu projeto)
    ...
    // ✅ CANCELA QUALQUER FALA ANTERIOR (limpa a garganta)
    window.speechSynthesis.cancel();
    
    // ✅ FRASE DE AQUECIMENTO TOTALMENTE SILENCIOSA
    const utterance = new SpeechSynthesisUtterance(" ");
    utterance.lang = idiomaLocal; // ✅ MESMO IDIOMA DA SUA BANDEIRA
    utterance.volume = 0;         // ✅ SILENCIOSO - usuário NÃO OUVE
    utterance.rate = 0.9;         // ✅ MESMA VELOCIDADE DO SEU PROJETO
    
    // ✅ PREPARA O MOTOR (aquece a garganta)
    ...
    async function requestMicrophonePermission() {
        try {
            ...
            if (hasMicrophonePermission) {
                ...
                // ✅ AQUI: PRÉ-AQUECIMENTO APÓS AUTORIZAÇÃO CONFIRMADA
                preaquecerNarrador();
                return;
            }
            ...
            // ✅ AQUI: PRÉ-AQUECIMENTO APÓS NOVA AUTORIZAÇÃO
            preaquecerNarrador();
