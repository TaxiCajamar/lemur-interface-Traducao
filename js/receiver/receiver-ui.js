...
document.getElementById('logo-traduz').addEventListener('click', function() {
    ...
    console.log('✅ QR Code gerado/reativado!');
        ...
        // 🟢 INÍCIO DA FUNÇÃO CORRIGIDA - falarComGoogleTTS
// 🎤 FUNÇÃO GOOGLE TTS SEPARADA (SEM imagem)
...
// 🟢 FIM DA FUNÇÃO CORRIGIDA - falarComGoogleTTS

       // 🟢 INÍCIO DO BLOCO CORRIGIDO - DataChannelCallback
window.rtcCore.setDataChannelCallback(async (mensagem) => {
    ...
    // 🎤 CHAMADA PARA GOOGLE TTS (SEM imagem)
    await falarComGoogleTTS(mensagem, elemento);
});
// 🟢 FIM DO BLOCO CORRIGIDO - DataChannelCallback
